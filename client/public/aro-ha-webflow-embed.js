 ...
 * 2. Paste this entire script in the Footer Code section
 * 3. Save and publish the site
 * 
 * FEATURES:
 * - Creates a floating chat button with the Aro-Ha custom icon
 * - Opens directly to chat mode, ready for use
 * - Properly handles pointer-events for non-interference
 * - Responsive design with fullscreen on mobile
 * - Smart positioning and transitions
 */
(function() {
  // Configuration
  const config = {
